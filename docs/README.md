...
- [Example Report Content](./content/example-report.md)

### Technical Specs
- [Master Specification](./specs/master-spec.md) — Architecture, tooling, routing rules
- [SEO & LLM Strategy](./specs/seo-strategy.md) — Discovery optimization

### Design
- [Design Tokens](./design/design-tokens.md) — Colors, typography, spacing

### Context
- [Product Overview](./context/product-overview.md) — What ShouldI is
